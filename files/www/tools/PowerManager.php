    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; outline: none; }
        body {
            ...
            padding: 20px; display: flex; flex-direction: column; min-height: 100vh; align-items: center; justify-content: center; -webkit-font-smoothing: antialiased;
        }
        .con { width: 100%; max-width: 420px; }
        .card { 
            background: var(--card-bg); backdrop-filter: var(--blur-val); -webkit-backdrop-filter: var(--blur-val);
            padding: 35px 30px; border-radius: 28px; box-shadow: var(--shadow); border: 1px solid var(--border); 
        ...
        h1 { font-size: 1.4rem; font-weight: 800; margin-bottom: 10px; color: var(--text-main); text-transform: uppercase; letter-spacing: 1px; }
...
<body>
    <div class="con">
        <div class="card">
            ...
            <div class="grid">
                <button class="btn" onclick="cf('reboot', 'Reboot', 'Restart system immediately?')">
                ...
                <button class="btn" onclick="cf('shutdown', 'Shutdown', 'Power off device?')">
                ...
                <button class="btn" onclick="cf('recovery', 'Recovery', 'Boot to recovery mode?')">
                ...
                <button class="btn" onclick="cf('fastboot', 'Fastboot', 'Boot to bootloader?')">
