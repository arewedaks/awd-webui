...
<head>
    ...
    <style>
        ...
        .item { display: flex; align-items: center; justify-content: space-between; padding: 16px 20px; background: rgba(255, 255, 255, 0.05); border: 1px solid var(--border); border-radius: 16px; cursor: pointer; transition: 0.3s; }
        ...
        .btn-update { width: 100%; padding: 16px; border: none; border-radius: 16px; background: var(--primary); color: white; font-weight: 800; font-size: 0.85rem; cursor: pointer; margin-top: 25px; transition: 0.3s; text-transform: uppercase; letter-spacing: 1px; box-shadow: 0 4px 15px rgba(184, 115, 51, 0.2); }
...
<body>
    <div class="header">
        <h1>Module Fix</h1>
        <div class="sub-t">Module Blacklist Manager</div>
    </div>
    ...
    <form method="POST" class="card">
        ...
        <button type="submit" name="save" class="btn-update">Update Blacklist</button>
    </form>
